...
<html lang="en">
  <head>
    ...
    <title>OGRS | Complaint History</title>
      <!-- Bootstrap core CSS -->
                      ...
                      <div class="content-panel">
                          <section id="unseen">
                            <table class="table table-bordered table-striped table-condensed">
                              ...
                              <tbody>
  <?php $query=mysqli_query($bd, "select * from complaint where cmpid='".$_SESSION['id']."'");
while($row=mysqli_fetch_array($query))
{
  ?>
                              <tr>
                                  <td align="center"><?php echo htmlentities($row['cmpid']);?></td>
...
<?php } ?>
                                   <td align="center">
                                   <a href="cdetails.php?cmpid=<?php echo htmlentities($row['cmpid']);?>">
