...
<!DOCTYPE html>
<html>
<title>Admin | Denied complaints</title>
...
$count=1;
$sel_query="Select * from complaint where status = 'deny' order by cmpid";
...
<td align="center">
<a href="javascript:void(0);" onClick="popUpWindow('http://localhost/og/dedetails.php?uid=<?php echo htmlentities($row['cmpid']);?>');" title="Details">
