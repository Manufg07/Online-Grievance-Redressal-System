...
?>
    ...
    <tr>
      <td colspan="2"><b>Final Report</b></td>
  ...
  echo "Inactive";
    ...
    <form action="finalreport1.php?uid=<?php echo htmlentities($row['cmpid']); ?>" method="post">
      <tr height="50">
      <td><b>Final Report : </b></td>
      <td><textarea name="feed"></textarea></td></tr>
    <tr><td colspan="2">
              <input type="submit" name="submit" class="btn btn-primary" value="Submit Report"></td></tr><br>
                  <tr>
