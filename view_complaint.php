...
<!DOCTYPE html>
<html>
<title>Student | View complaint</title>
...
$name = $_SESSION['sname'];
$count=1;
$sel_query="Select * from complaint where name = '$name' order by cmpid";
...
<td align="center">
<a href="javascript:void(0);" onClick="popUpWindow('http://localhost/og/fulldetails.php?uid=<?php echo htmlentities($row['cmpid']);?>');" title="Details">
