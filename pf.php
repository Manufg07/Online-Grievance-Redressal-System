          ...
          <section class="wrapper">
          	...
          	<div class="row mt">
                  ...
                  <div class="form-panel">
                  	...
                  	<?php// $query=mysqli_query ( "select * from student where sname='".$_SESSION['username']."'");
...
<div class="col-sm-4">
<input type="text" name="sname" required="required" value="<?php echo htmlentities($row['sname']);?>" class="form-control" readonly>
 </div>
