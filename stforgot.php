...
<body style="background-image: url('fgt.jpeg'); background-repeat: no-repeat; background-attachment: fixed; background-size: 100% 100%;">
	<br><br>
    <center>
    ...
    <div class="wrapper" style="background-color:White; border: 2px solid White; border-radius: 5px;"><big>
        ...
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post" autocomplete="off">
            ...
            <p>Go Back <a href="stlogin.php">Click Here</a></p>
