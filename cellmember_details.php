...
<!DOCTYPE html>
<html>
<title>Admin | Cell member details</title>
...
<div class="w3-blue">
  ...
  <h2 style="color:White; text-align:center">CELL MEMBER DETAILS</h2>
...
$count=1;
$sel_query="Select * from cellmember order by cname";
$result = mysqli_query($link,$sel_query);
while($row = mysqli_fetch_assoc($result)) { ?>
<tr><td align="center"><?php echo $count; ?></td>
<td align="center"><?php echo $row["cname"]; ?></td>
<td align="center">
<a href="javascript:void(0);" onClick="popUpWindow('http://localhost/og/cdetails.php?uid=<?php echo htmlentities($row["userid"]);?>');" title="Details">
<button type="button" class="btn btn-primary">Click Here</button></a>
</td>
<td align="center">
  <a href="cdelete.php?id=<?php echo $row["userid"]; ?>">Delete</a>
</td>
