...
<!DOCTYPE html>
<html>
<title>Admin | Approved complaints</title>
...
$count=1;
$sel_query="Select * from complaint where status = 'approve' or status ='processing' or status='closed' or status='reinstate' order by cmpid";
...
<td align="center">
<a href="javascript:void(0);" onClick="popUpWindow('http://localhost/og/apdetails.php?uid=<?php echo htmlentities($row['cmpid']);?>');" title="Details">
