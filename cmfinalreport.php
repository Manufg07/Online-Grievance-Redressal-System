...
<!DOCTYPE html>
<html>
<title>Cell member | Final report</title>
...
<th><center>Submit Report</center></th>
</tr>
</thead>
<tbody>
<?php
...
$count=1;
$sel_query="Select * from complaint where status = 'finalized' order by priority";
...
<td align="center">
<a href="javascript:void(0);" onClick="popUpWindow('http://localhost/og/finalreport.php?uid=<?php echo htmlentities($row['cmpid']);?>');" title="Details">
