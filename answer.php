...
<!DOCTYPE html>
<html>
<title>Cell member | Answers</title>
...
$count=1;
$sel_query="Select * from queries order by qid";
...
<td align="center">
<a href="javascript:void(0);" onClick="popUpWindow('http://localhost/og/write.php?uid=<?php echo htmlentities($row['qid']);?>');" title="Details">
