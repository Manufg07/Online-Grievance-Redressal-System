...
<!DOCTYPE html>
<html>
<title>Cell member | Anonymous complaints</title>
...
<div class="w3-blue">
  ...
  <h2 style="color:White; text-align:center">ANONYMOUS COMPLAINTS</h2>
...
$count=1;
$sel_query="Select * from complaint where type='anym' and (status='approve' or status='processing' or status='closed') order by priority";
...
<td align="center">
<a href="javascript:void(0);" onClick="popUpWindow('http://localhost/og/astatuschange.php?uid=<?php echo htmlentities($row['cmpid']);?>');" title="Details">
