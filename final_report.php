...
<!DOCTYPE html>
<html>
<title>Admin | Final report</title>
...
$count=1;
$sel_query="Select * from complaint where status = 'Report Submitted' order by cmpid";
...
<td align="center"><a href="javascript:void(0);" onClick="popUpWindow('http://localhost/og/final.php?uid=<?php echo htmlentities($row['cmpid']);?>');" title="Details">
